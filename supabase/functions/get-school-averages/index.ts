...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Fetching school averages for assessment IDs:', assessmentIds)

    // Call the database function
    const { data, error } = await supabaseClient.rpc('get_school_subject_averages', {
    ...
    console.log('Successfully fetched school averages:', data?.length, 'records')
